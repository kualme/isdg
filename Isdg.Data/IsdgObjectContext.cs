...
namespace Isdg.Models
{
    ...
    /// Object context
    /// </summary>
    public class IsdgObjectContext : DbContext, IDbContext
    {
        #region Ctor

        public IsdgObjectContext()
            : base("IsdgObjectContext")
        {
            //((IObjectContextAdapter) this).ObjectContext.ContextOptions.LazyLoadingEnabled = true;
        }

        public IsdgObjectContext(string nameOrConnectionString)
