...
{    
    public class ExecutiveBoardController : BaseController
    {
        private readonly IExecutiveBoardService executiveBoardService;

        public ExecutiveBoardController(IExecutiveBoardService executiveBoardService, ILog log, IEmailSender emailSender)
        ...
        {
            var members = executiveBoardService.GetAllMembers();
            return View(members);
        }
